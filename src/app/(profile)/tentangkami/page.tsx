        ...
        <div className="container mx-auto px-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700">
              SKB diresmikan oleh Bapak Menkokesra Alamsyah Ratu Perwiranegara
              pada tanggal 2 Maret 1987. Sanggar Kegiatan Belajar dengan
              Kepmendikbud RI Nomor 036/O/1989 tanggal 20 Januari 1989 tentang
              Organisasi dan Tata Kerja SKB dengan nama SKB Tanjungpandan secara
              Teknis dibina oleh Ditjen Diklusepora hingga diterbitkannya
              Kepmendikbud RI Nomor 023/O/1997 tanggal 20 Februari 1997 tentang
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700">
              Mewujudkan masyarakat cerdas, terampil dan berakhlak mulia melalui
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-gray-700">
              ...
              <li>
                Membuadayakan peserta didik menggunakan teknologi informasi dan
              ...
              <li>
                Tercapainya lingkungan SPNF SKB Belitung yang bersih, Asri dan
                nyaman
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-gray-700">
              ...
              <li>
                ...
                kepala SKB yang dalam melaksanakan tugasnya berada dibawah dan
                bertanggungjawab kepada Kepala Dinas Pendidikan dan Kebudayaan
                Kabupaten Belitung melalui Kepala Bidang Pendidikan Anak Usia
                Dini dan Nonformal.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4">Tugas dan Fungsi</h2>
            <p className="text-gray-700 mb-4">
              Melaksanakan sebagian Tugas Dinas dalam menyelenggarakan membina,
              mendampingi dan membuat percontohan pelaksanaan program PAUD dan
            ...
            <ul className="list-disc list-inside text-gray-700">
              ...
              <li>
                Pendampingan bagi Satuan Pendidikan lain yang menyelenggarakan
              ...
              <li>
                Pemberian Motivasi kepada Masyarakat dalam rangka terciptanya
